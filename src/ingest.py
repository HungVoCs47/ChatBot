...
class FileReader:
    ...
    def read_csv(self, file_path):
        ...
        text_list = df['full_description'].tolist()
...
def main():
    ...
    documents = file_reader.read_csv('data/property_listings.csv')
    ...
    indexer = VectorIndexer(nodes=documents, vector_store=vector_store, embedding_model=embedding_model.embedding_model)
